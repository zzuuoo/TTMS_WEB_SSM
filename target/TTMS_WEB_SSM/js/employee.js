    ...
    $.each(emps,function (index,item) {
        ...
        var updatebtn = $("<button></button>").addClass("btn btn-primary btn-sm")
            .append("编辑").click(function () {
                ...
                $("#empId_Update_input").attr('value',item.empId);
   
                $("#empNo_Update_input").attr('value',item.empNo);
                $("#empName_Update_input").attr('value',item.empName);
                $("#empTelNum_Update_input").attr('value',item.empTelNum);
                $("#empAddr_Update_input").attr('value',item.empAddr);
                $("#empEmail_Update_input").attr('value',item.empEmail);

                //提交修改按钮事件
                $("#emp_submit_btn").click(function () {
                    emp_model_Update_btn(result);
...
//修改员工信息
function emp_model_Update_btn(info) {
    $.ajax({
        url:"/updateEmployee",
        data: $("#emp_Update_form").serializeArray(),
        type:"POST",
...
//模态框中点击删除
function emp_model_delete(info,item) {
    // alert(item.empId);
    $.ajax({
...
$("#emp_insert_submit_btn").click(function(){
